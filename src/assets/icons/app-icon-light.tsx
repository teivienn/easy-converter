...
export function AppIconLight(props: SvgProps) {
  return (
    <Svg width={108} height={108} viewBox="0 0 108 108" fill="none" {...props}>
      <Circle cx={69.9459} cy={72.1351} r={4.86486} fill="#9943EE" />
      <Circle cx={62.0406} cy={47.2027} r={15.2027} fill="#C78FFF" />
      <Circle cx={46.8379} cy={56.3245} r={18.2432} fill="#A24DF7" />
      <Path
